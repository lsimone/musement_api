...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusementApi.ActivityApi();
  });
  ...
  describe('ActivityApi', function() {
    ...
    describe('activityLanguagesGet', function() {
      it('should call activityLanguagesGet successfully', function(done) {
        //uncomment below and update the code to test activityLanguagesGet
        //instance.activityLanguagesGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
