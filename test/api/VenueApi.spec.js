...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusementApi.VenueApi();
  });
  ...
  describe('VenueApi', function() {
    ...
    describe('venuesVenueIdGet', function() {
      it('should call venuesVenueIdGet successfully', function(done) {
        //uncomment below and update the code to test venuesVenueIdGet
        //instance.venuesVenueIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
