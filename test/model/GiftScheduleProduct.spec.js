...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusementApi.GiftScheduleProduct();
  });
  ...
  describe('GiftScheduleProduct', function() {
    it('should create an instance of GiftScheduleProduct', function() {
      // uncomment below and update the code to test GiftScheduleProduct
      //var instane = new MusementApi.GiftScheduleProduct();
      //expect(instance).to.be.a(MusementApi.GiftScheduleProduct);
    });
