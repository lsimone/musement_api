...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusementApi.MusementListThirdpartyItem();
  });
  ...
  describe('MusementListThirdpartyItem', function() {
    it('should create an instance of MusementListThirdpartyItem', function() {
      // uncomment below and update the code to test MusementListThirdpartyItem
      //var instane = new MusementApi.MusementListThirdpartyItem();
      //expect(instance).to.be.a(MusementApi.MusementListThirdpartyItem);
    });
