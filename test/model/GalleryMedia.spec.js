...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusementApi.GalleryMedia();
  });
  ...
  describe('GalleryMedia', function() {
    it('should create an instance of GalleryMedia', function() {
      // uncomment below and update the code to test GalleryMedia
      //var instane = new MusementApi.GalleryMedia();
      //expect(instance).to.be.a(MusementApi.GalleryMedia);
    });
