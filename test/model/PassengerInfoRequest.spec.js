...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusementApi.PassengerInfoRequest();
  });
  ...
  describe('PassengerInfoRequest', function() {
    it('should create an instance of PassengerInfoRequest', function() {
      // uncomment below and update the code to test PassengerInfoRequest
      //var instane = new MusementApi.PassengerInfoRequest();
      //expect(instance).to.be.a(MusementApi.PassengerInfoRequest);
    });
