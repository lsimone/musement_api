...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusementApi.BlogpostBlockImage();
  });
  ...
  describe('BlogpostBlockImage', function() {
    it('should create an instance of BlogpostBlockImage', function() {
      // uncomment below and update the code to test BlogpostBlockImage
      //var instane = new MusementApi.BlogpostBlockImage();
      //expect(instance).to.be.a(MusementApi.BlogpostBlockImage);
    });
