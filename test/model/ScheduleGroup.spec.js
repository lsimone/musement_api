...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusementApi.ScheduleGroup();
  });
  ...
  describe('ScheduleGroup', function() {
    it('should create an instance of ScheduleGroup', function() {
      // uncomment below and update the code to test ScheduleGroup
      //var instane = new MusementApi.ScheduleGroup();
      //expect(instance).to.be.a(MusementApi.ScheduleGroup);
    });
