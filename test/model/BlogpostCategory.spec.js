...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusementApi.BlogpostCategory();
  });
  ...
  describe('BlogpostCategory', function() {
    it('should create an instance of BlogpostCategory', function() {
      // uncomment below and update the code to test BlogpostCategory
      //var instane = new MusementApi.BlogpostCategory();
      //expect(instance).to.be.a(MusementApi.BlogpostCategory);
    });
