...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusementApi.Deeplink();
  });
  ...
  describe('Deeplink', function() {
    it('should create an instance of Deeplink', function() {
      // uncomment below and update the code to test Deeplink
      //var instane = new MusementApi.Deeplink();
      //expect(instance).to.be.a(MusementApi.Deeplink);
    });
