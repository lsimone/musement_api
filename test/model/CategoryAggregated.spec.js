...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MusementApi.CategoryAggregated();
  });
  ...
  describe('CategoryAggregated', function() {
    it('should create an instance of CategoryAggregated', function() {
      // uncomment below and update the code to test CategoryAggregated
