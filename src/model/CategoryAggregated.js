...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MusementApi.CategoryAggregated = factory(root.MusementApi.ApiClient);
  }
  ...
  /**
   * The CategoryAggregated model module.
   * @module model/CategoryAggregated
   * @version 3.2.0
   */

  /**
   * Constructs a new <code>CategoryAggregated</code>.
   * @alias module:model/CategoryAggregated
   * @class
   */
  ...
  /**
   * Constructs a <code>CategoryAggregated</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CategoryAggregated} obj Optional instance to populate.
   * @return {module:model/CategoryAggregated} The populated <code>CategoryAggregated</code> instance.
   */
