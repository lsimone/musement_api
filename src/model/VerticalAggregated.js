...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MusementApi.VerticalAggregated = factory(root.MusementApi.ApiClient, root.MusementApi.Event);
  }
  ...
  /**
   * The VerticalAggregated model module.
   * @module model/VerticalAggregated
   * @version 3.2.0
   */

  /**
   * Constructs a new <code>VerticalAggregated</code>.
   * @alias module:model/VerticalAggregated
   * @class
   */
  ...
  /**
   * Constructs a <code>VerticalAggregated</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/VerticalAggregated} obj Optional instance to populate.
   * @return {module:model/VerticalAggregated} The populated <code>VerticalAggregated</code> instance.
   */
