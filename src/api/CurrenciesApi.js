...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    module.exports = factory(require('../ApiClient'), require('../model/Currency'));
  } else {
    // Browser globals (root is window)
    if (!root.MusementApi) {
      root.MusementApi = {};
    }
    root.MusementApi.CurrenciesApi = factory(root.MusementApi.ApiClient, root.MusementApi.Currency);
  }
  ...
  var exports = function(apiClient) {
     ...
     */
    this.currenciesGet = function(callback) {
      var postBody = null;
